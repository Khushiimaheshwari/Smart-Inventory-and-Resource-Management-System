          ...
          <table style={styles.table}>
            <thead>
              <tr>
                ...
                <th style={styles.th}>Asset Mgmt</th>
                <th style={styles.th}>Analytics</th>
                <th style={styles.th}>User Mgmt</th>
            ...
            <tbody>
              {users.map(user => (
                <tr key={user.id}>
                  ...
                  <td style={styles.td}>
                    {user.access.dashboard ? <span style={styles.checkIcon}>✓</span> : <span style={styles.crossIcon}>✗</span>}
                  </td>
                  <td style={styles.td}>
                    {user.access.assetManagement ? <span style={styles.checkIcon}>✓</span> : <span style={styles.crossIcon}>✗</span>}
                  </td>
                  <td style={styles.td}>
                    {user.access.analytics ? <span style={styles.checkIcon}>✓</span> : <span style={styles.crossIcon}>✗</span>}
                  </td>
                  <td style={styles.td}>
                    {user.access.userManagement ? <span style={styles.checkIcon}>✓</span> : <span style={styles.crossIcon}>✗</span>}
                  </td>
                  <td style={styles.td}>
                    {user.access.settings ? <span style={styles.checkIcon}>✓</span> : <span style={styles.crossIcon}>✗</span>}
                  </td>
                  <td style={styles.td}>
